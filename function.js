...
const createVideo = data => {
  ...
  let note = document.createElement('q');
  info.textContent = "Click the right button on video and select save video as...";
  note.textContent = "Note: If video does not open, then reclick on open button!";


  render.innerHTML = ""; 
  render.appendChild(v);
  render.appendChild(info);
  render.appendChild(note);
};
// create image
const createImg = data => {
  ...
  note.textContent = "Note: If image does not open, then reclick on open button!";
